...
def _get_full(
    ...
    if status != QueryStatus.FAILED:
        ...
        slice_name = query_context.slice_.slice_name if query_context.slice_ else None
        payload["data"] = query_context.get_data(df, payload["coltypes"], slice_name=slice_name)
